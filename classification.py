...
def main(root_path, test_data_set, model_dir):

    train(root_path, test_data_set, model_dir)

def train(root_path, directory, model_dir):
    # Load training and testing datasets.
    print(root_path + "/" + directory)
...
if __name__ == '__main__':
    main(ROOT_PATH, TEST_DATA_SET, MODEL_DIR)
